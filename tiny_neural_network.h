...
#ifndef _TINY_NEURAL_NETWORK_H
#define _TINY_NEURAL_NETWORK_H
...
namespace TINY
{
    ...
    protected:
        std::vector<::TINY::TinyNeuralNetworkActivation> activations_;
    ...
    public:
        ...
        void add_linear_layer(::TINY::TinyNeuralNetworkActivation activation, int units,
            bool learn_bias = true) {
