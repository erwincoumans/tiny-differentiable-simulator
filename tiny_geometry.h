...
#ifndef _TINY_GEOMETRY_H
#define _TINY_GEOMETRY_H
...
namespace TINY
{
    ...
    int contactSphereSphere(
        ...
        typedef ::TINY::TinyContactPoint<TinyScalar, TinyConstants> TinyContactPoint;
    ...
    int contactPlaneCapsule(
        ...
        const TinyPose<TinyScalar, TinyConstants>& poseB,
        std::vector<TinyContactPoint<TinyScalar, TinyConstants> >& contactsOut) {
        typedef ::TINY::TinyPose<TinyScalar, TinyConstants> TinyPose;
        typedef ::TINY::TinyPlane<TinyScalar, TinyConstants> TinyPlane;
