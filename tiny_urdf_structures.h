...
struct TinyUrdfCollisionPlane {
    ...
    TinyUrdfCollisionPlane()
        :m_normal(TinyVector3(TinyConstants::zero(), TinyConstants::zero(), TinyConstants::one())),
...
struct TinyUrdfCollisionBox {
    ...
    TinyUrdfCollisionBox()
        :m_extents(TinyVector3(TinyConstants::one(), TinyConstants::one(), TinyConstants::one()))
    {
    }
...
struct TinyUrdfCollisionMesh {
    ...
    TinyUrdfCollisionMesh()
        :m_scale(TinyVector3(TinyConstants::one(), TinyConstants::one(), TinyConstants::one()))
    {
    }
...
struct TinyUrdfJoint {
  ...
  TinyUrdfJoint()
      ...
      joint_origin_xyz(TinyVector3(TinyConstants::zero(), TinyConstants::zero(), TinyConstants::zero())),
      joint_origin_rpy(TinyVector3(TinyConstants::zero(), TinyConstants::zero(), TinyConstants::zero())),
      joint_axis_xyz(TinyVector3(TinyConstants::zero(), TinyConstants::zero(), TinyConstants::one()))
  {
  }
...
struct TinyUrdfStructures {
  ...
  std::map <std::string, TinyVisualMaterial<TinyScalar, TinyConstants> > m_materials;
