...
void TinyWin32OpenGLWindow::create_window(const TinyWindowConstructionInfo& ci)
{
...
void TinyWin32OpenGLWindow::end_rendering()
{
	SwapBuffers(m_data->m_hDC);
}

int TinyWin32OpenGLWindow::file_open_dialog(char* fileName, int maxFileNameLength)
{
#if 0
