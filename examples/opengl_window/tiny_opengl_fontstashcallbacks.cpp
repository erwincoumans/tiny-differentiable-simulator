...
OpenGL2RenderCallbacks::OpenGL2RenderCallbacks(TinyGLPrimitiveRenderer* primRender)
...
void InternalOpenGL2RenderCallbacks::update_texture(sth_texture* texture, sth_glyph* glyph, int textureWidth, int textureHeight)
{
	assert(glGetError() == GL_NO_ERROR);
