...
void GLFWOpenGLWindow::mouseButtonCallbackInternal(int button, int state)
{
	...
	{
		get_mouse_button_callback()(button, state, m_data->m_cursorXPos, m_data->m_cursorYPos);
	}
}
...
void GLFWOpenGLWindow::create_default_window(int width, int height, const char* title)
{
...
float GLFWOpenGLWindow::get_time_in_seconds()
{
	return 0.f;
}
...
void GLFWOpenGLWindow::set_mouse_move_callback(b3MouseMoveCallback mouseCallback)
{
...
void GLFWOpenGLWindow::set_mouse_button_callback(b3MouseButtonCallback mouseCallback)
{
...
void GLFWOpenGLWindow::set_resize_callback(b3ResizeCallback resizeCallback)
{
	...
	getResizeCallback()(m_data->m_width / get_retina_scale(), m_data->m_height / get_retina_scale());
}
...
void GLFWOpenGLWindow::set_keyboard_callback(b3KeyboardCallback keyboardCallback)
{
