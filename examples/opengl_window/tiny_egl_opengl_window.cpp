...
void EGLOpenGLWindow::set_mouse_move_callback(TinyMouseMoveCallback mouseCallback)
{
...
void EGLOpenGLWindow::set_keyboard_callback(TinyKeyboardCallback keyboardCallback)
{
