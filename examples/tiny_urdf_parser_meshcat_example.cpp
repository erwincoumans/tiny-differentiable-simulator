...
int main(int argc, char* argv[]) {
  ...
  TinyFileUtils::extract_path(plane_file_name.c_str(), plane_search_path, TINY_MAX_EXE_PATH_LEN);
  TinyMultiBody<double, DoubleUtils>& plane_mb = *world.create_multi_body();
  plane_mb.m_isFloating = false;
  {
      TinyUrdfStructures<double, DoubleUtils> plane_urdf_structures = parser.load_urdf(plane_file_name);
