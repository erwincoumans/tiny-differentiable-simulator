...
int main(int argc, char* argv[]) {
    ...
    FileUtils::find_file("sphere2.urdf", file_name);
    ...
    mb.set_orientation(TinyQuaternion<double, DoubleUtils>(-0.765185, 0.000000, 0.000000, 0.643811));
    world.default_friction = 1.0;

    TinyVector3<double, DoubleUtils> grav(DoubleUtils::zero(),
        DoubleUtils::fraction(2, 1),
        DoubleUtils::fraction(-10, 1));
    double dt = 1. / 1000.;
    int sync_counter = 0;
    int frame = 0;
